...
/**
 * The operator page's phase table must have rows.
 *
 * It is generated by parsing docs/run/AUTONOMOUS_RUN.md, and that file was empty for the whole run:
 * a phase-status edit removed its contents and every later "record status" wrote a string
 * replacement into an empty file and silently succeeded. The deployed page showed an empty table
 * and nothing failed. An evidence audit found it. A generator that silently produces nothing is the
